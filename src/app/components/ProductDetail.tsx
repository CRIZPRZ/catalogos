...
export function ProductDetail({ product, onClose }: ProductDetailProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 overflow-y-auto py-8 px-4">
      <div className="bg-white rounded-xl max-w-4xl mx-auto shadow-2xl">
        {/* Header */}
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 p-4 md:p-6">
          ...
          <div className="space-y-3">
            {/* Main image */}
            <div className="relative h-56 sm:h-80 md:h-96 bg-gray-100 rounded-lg overflow-hidden">
              <ImageWithFallback
              ...
              {allImages.length > 1 && (
                <>
                  <button
                    onClick={prev}
                    className="absolute left-2 top-1/2 -translate-y-1/2 bg-white bg-opacity-80 hover:bg-opacity-100 rounded-full p-1 shadow transition-all"
                  >
                    <ChevronLeft size={20} className="text-gray-700" />
                  </button>
                  <button
                    onClick={next}
                    className="absolute right-2 top-1/2 -translate-y-1/2 bg-white bg-opacity-80 hover:bg-opacity-100 rounded-full p-1 shadow transition-all"
                  >
          ...
          <div className="flex flex-col min-h-0">
            {/* Scrollable content */}
            <div className="overflow-y-auto flex-1 max-h-[280px] sm:max-h-[360px] md:max-h-[400px] space-y-4 md:space-y-6 pr-1 mb-4">
              <div>
            ...
            {/* Price and WhatsApp — always visible */}
            <div className="pt-4 border-t">
              <div className="flex items-center justify-between mb-4">
                ...
                {product.inStock && <span className="text-green-600 text-sm">En Stock</span>}
              </div>
              <button
